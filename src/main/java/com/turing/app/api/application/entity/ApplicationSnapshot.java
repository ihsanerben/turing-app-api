...
public class ApplicationSnapshot {
  ...
  public static ApplicationSnapshot create(
      Application app, int schemaVersion, Map<String, Object> data, Instant now) {
    ApplicationSnapshot value = new ApplicationSnapshot();
    value.id = UUID.randomUUID();
    value.application = app;
    value.schemaVersion = schemaVersion;
    value.profileData = new LinkedHashMap<>(data);
    value.createdAt = now;
    return value;
  }
}

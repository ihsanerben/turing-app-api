...
public class ApplicationController {
  ...
  @GetMapping
  public List<ApplicationResponse> list(@AuthenticationPrincipal AuthenticatedUser user) {
  ...
  public ApplicationFormResponse form(
      @AuthenticationPrincipal AuthenticatedUser user, @PathVariable UUID id) {
    return service.form(user.id(), id);
  }

  @PutMapping("/{id}/answers")
  public ApplicationFormResponse answers(
      @AuthenticationPrincipal AuthenticatedUser user,
      @PathVariable UUID id,
      @Valid @RequestBody AnswersUpdateRequest body) {
    return service.saveAnswers(user.id(), id, body);
  }
  ...
  public ApplicationResponse withdraw(
      ...
      @PathVariable UUID id,
      @Valid @RequestBody ApplicationVersionRequest body) {
    return service.withdraw(user.id(), id, body);
  }
}

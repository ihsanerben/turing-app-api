...
public class AuthSession {
  ...
  public static AuthSession create(
      User user, UUID familyId, String hash, Instant expiresAt, Instant now) {
    return createWithId(UUID.randomUUID(), user, familyId, hash, expiresAt, now);
  }

  public static AuthSession createWithId(
      UUID id, User user, UUID familyId, String hash, Instant expiresAt, Instant now) {

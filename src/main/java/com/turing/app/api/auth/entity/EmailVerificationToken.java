...
public class EmailVerificationToken {
    ...
    public static EmailVerificationToken create(User user, String hash, Instant expires, Instant now) {
        EmailVerificationToken token = new EmailVerificationToken(); token.id = UUID.randomUUID(); token.user = user;

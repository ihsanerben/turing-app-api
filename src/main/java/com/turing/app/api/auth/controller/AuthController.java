...
public class AuthController {
  ...
  public AuthController(AuthService authService, CookieService cookies) {
  ...
  public MessageResponse register(@Valid @RequestBody RegisterRequest request) {
    ...
    return new MessageResponse("Kayıt oluşturuldu. E-postanızı doğrulayın.");
  }

  @PostMapping("/verify-email")
  public MessageResponse verify(@Valid @RequestBody TokenRequest request) {
    authService.verifyEmail(request.token());
    return new MessageResponse("E-posta adresi doğrulandı.");
  }

  @PostMapping("/resend-verification")
  public MessageResponse resend(@Valid @RequestBody EmailRequest request) {
    return new MessageResponse(authService.resendVerification(request.email()));
  }
  ...
  public ResponseEntity<UserResponse> refresh(HttpServletRequest request) {
    ...
    if (raw == null)
      throw new com.turing.app.api.auth.exception.AuthException(
          HttpStatus.UNAUTHORIZED, "MISSING_REFRESH_TOKEN", "Oturum yenilenemedi.");
  ...
  public MessageResponse forgot(@Valid @RequestBody EmailRequest request) {
  ...
  public MessageResponse reset(@Valid @RequestBody ResetPasswordRequest request) {
    ...
    return new MessageResponse("Şifreniz yenilendi. Tekrar giriş yapabilirsiniz.");
  }

  private ResponseEntity<UserResponse> withCookies(AuthTokens tokens) {
    return ResponseEntity.ok()
        .header(HttpHeaders.SET_COOKIE, cookies.access(tokens.accessToken()).toString())

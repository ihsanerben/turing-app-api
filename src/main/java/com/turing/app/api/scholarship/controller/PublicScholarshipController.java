...
public class PublicScholarshipController {
  ...
  @GetMapping
  public List<PublicScholarshipResponse> list() {
    return service.publicPrograms();
  }

  @GetMapping("/{slug}")
  public PublicScholarshipResponse detail(@PathVariable String slug) {
    return service.publicProgram(slug);
  }
}

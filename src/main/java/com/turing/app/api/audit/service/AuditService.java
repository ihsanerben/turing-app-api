...
public class AuditService {
    ...
    public void recordProfileCorrection(UUID actorId, UUID profileId, String oldValues, String newValues, String ip) {
        jdbc.update("""
                ...
                VALUES (:id, :actor, 'PROFILE_CORRECTED', 'STUDENT_PROFILE', :entity, CAST(:old AS jsonb), CAST(:new AS jsonb), :ip, :requestId, :createdAt)
                """, Map.of("id", UUID.randomUUID(), "actor", actorId, "entity", profileId, "old", oldValues,

...
public class AuditService {
  ...
  public AuditService(NamedParameterJdbcTemplate jdbc, Clock clock) {
    this.jdbc = jdbc;
    this.clock = clock;
  }

  public void recordProfileCorrection(
      UUID actorId, UUID profileId, String oldValues, String newValues, String ip) {
